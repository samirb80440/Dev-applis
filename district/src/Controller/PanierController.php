...
class PanierController extends AbstractController
{
    ...
    public function Ajoutplats(SessionInterface $session,Plat $plat): Response
    {
        $panier = $session->get('panier', []);
        $id = $plat->getId();
    ...
    public function Enleverplats(SessionInterface $session,Plat $plat): Response
    {
    $panier =$session->get('panier',[]);
    $id = $plat->getId();
    ...
    public function Supprimerplats(SessionInterface $session, Plat $plat): Response
    {
        $panier = $session->get('panier',[]);
        $id = $plat->getId();
